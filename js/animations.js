(function () {
    ...
    TweenMax.staggerTo(".satellitePulse", .8, {
        alpha: 0,
        repeat: -1,
        ease: Power2.easeInOut,
        yoyo: !1
    ...
    for (a = 0; 7 > a; a++) b = document.querySelector("#speedLine" + a),
        d = new TimelineMax({
            repeat: -1,
    ...
    for (a = 0; 7 > a; a++) c = e.cloneNode(!0),
        k.appendChild(c), b = (a + 1) / 2,
        TweenMax.fromTo(c, b, {
            x: 600 * Math.random(),
            y: -30,
            scale: 3 - b
